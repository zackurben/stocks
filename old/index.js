...
cli.parse({
  ...
  interactive: ['i', 'Interact with stocks', 'bool', defaults.interactive],
  add: ['a', 'Add a stock to the portfolio with a inline csv: symbol,shares,price[,m/d/y date]', 'string', defaults.add]
});
